  ...
  return (
    <Layout>
      ...
      <Container>
        ...
        <Row>
          <Col>
            <p>In <em>"From the Root to the Fruit: Portraits of Black Fathers and their Children"</em> <a target="_blank" rel="noreferrer" style={{ textDecoration: 'none', color:'#CB6137'}} href="https://www.kenmcfarlanephoto.com/">Ken McFarlane</a> presents an ongoing documentary project that celebrates Black fatherhood while deconstructing the false narrative of the absentee Black Father.  Originally presented by <a target="_blank" style={{ textDecoration: 'none', color:'#CB6137'}} rel="noreferrer" href="https://tractioncompany.com/">Traction Company</a> on 41st Street and Haverford in Mantua and curated by Traction artist Sedakial Gebremedhin, this is a second public phase of this ongoing work. McFarlane’s work amplifies images of strength, dignity, pride and success to drown out the cacophony of negative imagery surrounding the Black body.</p>
          </Col>
        </Row>
        <Row>
          <Col>
