...
const AboutPage = () => (
  <Layout>
    <SEO title="The Artist" />
    <Container style={{ maxWidth: '650px', lineHeight: '1.6'}}>
      <Row>
        <Col className='mt-3'>
          <h1 style={{ fontFamily: 'Alfa Slab One', fontWeight: '400' }}>The Artist</h1>
        </Col>
      </Row>
      <Row>
        <Col>
